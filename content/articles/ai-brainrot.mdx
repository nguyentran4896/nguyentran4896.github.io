...
<figure className="my-12 -mx-6 sm:mx-0">
  <img
    src="/articles/ai-brainrot/hero.jpg"
    alt="A figure silhouetted against the cold light of a phone, dissolving into drifting video frames"
    width="1600"
    height="678"
    className="w-full h-auto sm:rounded-md border-y sm:border border-border"
  />
...
<div className="not-prose my-10 grid grid-cols-1 sm:grid-cols-3 gap-px bg-border border border-border rounded-md overflow-hidden">
  <div className="bg-background p-6">
    ...
    <p className="mt-3 text-sm leading-relaxed text-foreground/65">Short-form video, served by a recommender tuned for retention, not coherence.</p>
  </div>
  <div className="bg-background p-6">
    <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground mb-3">
      Daily feed time
    ...
    <p className="mt-3 text-sm leading-relaxed text-foreground/65">Average for under-25s. That's roughly one feature film, every day, in fragments.</p>
  </div>
  <div className="bg-background p-6">
    <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground mb-3">
      Swipes per minute
    ...
    <p className="mt-3 text-sm leading-relaxed text-foreground/65">Peak velocity during evening sessions. A decision every 1.5 seconds about whether to keep paying attention.</p>
  </div>
</div>
...
<figure className="my-12 -mx-6 sm:mx-0">
  <img
    src="/articles/ai-brainrot/loops.jpg"
